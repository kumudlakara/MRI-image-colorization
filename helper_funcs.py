...
def load_data(subfolder='', generator=False):
    def create_image_array(image_list, image_path, image_size, nr_of_channels):
        ...
        # Define image array
        image_array = np.empty((len(image_list),) + (image_size) + (3,))
        i = 0
    ...
    # Image paths
    trainA_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/', 'TrainT1')
    #trainB_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/', 'TrainT2_Colored')
    trainB_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/', 'TrainT2')
    testA_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/', 'TestT1')
    #testB_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/','TestT2_Colored')
    testB_path = os.path.join('/content/drive/MyDrive/Medical-Image-Synthesis/data/T1-T2/', 'TestT2')
    ...
    #im_test = cv2.imread(os.path.join(trainA_path, trainA_image_names[0]))
